...
class ChangeColor extends StatefulWidget {
  ...
  final bool collapseable;
  final ValueSetter<bool> valueSetterCollapsed;
      ...
      child: Column(
        children: <Widget>[
          ...
          GestureDetector(
            ...
            onTap: widget.collapseable
                ? () {
                    setState(() {
                      _collapsed = !_collapsed;
                      widget.valueSetterCollapsed(_collapsed);
                    });
                  }
                : null,
            child: Row(
                  ...
                  child: Chip(
                    ...
                    backgroundColor: () {
                      if (_colorShade.color == null) {
                        _colorShade.color = getNativeThemeData(
          ...
          Visibility(
            visible: widget.collapseable ? !_collapsed : true,
            child: Container(
              height: 70.0,
