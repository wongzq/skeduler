...
class _HomeState extends State<Home> {
  ...
  GroupMetadata _groupMetadata = GroupMetadata();
  ValueNotifier<String> _groupDocId = ValueNotifier(null);

  void refresh({String groupName}) => setState(() {
    _groupMetadata.name = groupName;
  });
  ...
  void initState() {
    _screens = {
      DrawerEnum.dashboard: {
        'title': 'Dashboard',
        'screen': DashboardScreen(refresh: refresh),
      },
      DrawerEnum.group: {
        'title': 'Group',
        'screen': GroupScreen(refresh: refresh),
      },
      DrawerEnum.timetable: {'title': 'Timetable', 'screen': null},
      DrawerEnum.classes: {'title': 'Classes', 'screen': null},
      DrawerEnum.people: {'title': 'People', 'screen': null},
      DrawerEnum.profile: {'title': 'Profile', 'screen': null},
      DrawerEnum.settings: {'title': 'Settings', 'screen': null},
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<GroupMetadata>.value(
          value: _groupMetadata,
        ),
      ],
      child: Consumer<ValueNotifier<DrawerEnum>>(
        builder: (BuildContext context, ValueNotifier<DrawerEnum> selected,
            Widget widget) {
          return Scaffold(
            /// Scaffold - appBar
            appBar: AppBar(
              backgroundColor: Theme.of(context).primaryColor,
              title: _groupMetadata.name == null
                  ? Text(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ListTile(
                          ...
                          selected: selected.value == DrawerEnum.people
                              ? true
                              : false,
                          onTap: () {
                      ...
                      Container(
                        ...
                        child: ListTile(
                          ...
                          selected: selected.value == DrawerEnum.logout
                              ? true
                              : false,
                          onTap: () {
